...
models_to_evaluate = {'sbs':SingleBestSolver(),
...
for model_name, models_to_evaluate in list(models_to_evaluate.items())[1:]:
    tmp_model = copy.deepcopy(models_to_evaluate)
    performance_times[model_name] = {}
    for scenario_name in ['CSP-2010','QBF-2016', 'ASP-POTASSCO','SAT12-HAND', 'MAXSAT15-PMS-INDU','SAT12-INDU','CPMP-2015',]:
