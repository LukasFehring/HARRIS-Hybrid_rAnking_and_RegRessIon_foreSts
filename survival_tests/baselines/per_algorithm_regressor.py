...
from .utils import distr_func, impute_censored
...
class PerAlgorithmRegressor:
    ...
    def fit(self, scenario: ASlibScenario, fold: int, amount_of_training_instances: int):
        ...
        for algorithm_id in range(self.num_algorithms):
            ...
            if self.impute_censored:
                ...
                model = impute_censored(X_train, y_train, censored, model, distr_func, self.algorithm_cutoff_time)
    ...
    def get_name(self):
        ...
        name += "per_algorithm_{}_regressor".format(type(self.scikit_regressor).__name__)
        return name
